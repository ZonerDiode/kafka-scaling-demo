...
docker exec -it kafka1 kafka-topics --create --topic events.raw --partitions 1 --replication-factor 3 --bootstrap-server kafka1:9092

Write-Host "Waiting for topic to become healthy..."
